function [elementNodes,ang,rate,nodeCoordinates,nodeCount,element,growthNode,ro,rinn,phi]=nucleate3D_MM(numberBeamsx,numberBeamsy,h_span,v_span,avgRate,rout,ri,rate_stdev,ang_stdev)

for o=1:numberBeamsx;
    origin1(o)=h_span/(numberBeamsx)*(o-1/2)*1e-6;
end

for p=1:numberBeamsy
    origin2(p)=v_span/(numberBeamsy)*(p-1/2)*1e-6;
end
