function [gap, sep,closeNodes] =FindCloseNodesSparseCyl(nodeCoordinates,nodeCount,numberBeams,t,rmax)      
...
ii=1:ceil(numberBeamsRad/4);
CNTlist(number)=numberBeamsy*(o-1)+count;
    

        for s=CNTlist(1):(number);
