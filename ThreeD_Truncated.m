...
fname = 'C:\Users\MattMaschmann\Documents\MATLAB\ImageFolder\3D\30x30';
%fname ='/home/mmaschma/data/3D_Vector/Output/40_40';
steps=250;% Number of time steps
h_span=8;% Span of the substrate lengthwise(meters)
v_span=8;% Span of the substrate breadthwise(meters)
...
ContinuousPlot=1; plotint=10;% 0=plotting off.  1=plotting on
...
contactingNodes=zeros(steps,1); oldCloseNodes=[1 2];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
