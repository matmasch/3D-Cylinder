...
h_span=2.5;% Span of the substrate lengthwise(meters)
v_span=2.5;% Span of the substrate breadthwise(meters)
numberBeamsx=20;% Number of CNTs to be modeled lengthwise
numberBeamsy=20;% Number of CNTs to be modeled breadthwise
...
for ff=1:numberBeams
    ...
    kkforce(2*numberBeams+ff)=E*A(ff)*cos(ang(ff))+(0.05-0.05*rand)*E*A(ff)*cos(ang(ff));
