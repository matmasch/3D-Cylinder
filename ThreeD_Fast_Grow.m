...
%fname='\\tsclient\MattMaschmann\Documents\MATLAB\ImageFolder\3D\FAST'
%fname ='/home/mmaschma/data/3Dcode/Output/test10';
steps=100;% Number of time steps
h_span=3;% Span of the substrate lengthwise(meters)
v_span=3;% Span of the substrate breadthwise(meters)
numberBeamsx=40;% Number of CNTs to be modeled lengthwise
numberBeamsy=40;% Number of CNTs to be modeled breadthwise
...
if ContinuousPlot==1
   ...
   %CNTPlotBWpoint(fname,avgRate, steps, h_span, numberBeams,ContinuousPlot,nodeCount,nodeCoordinates,t,title,totalCompress, compressiveLoad,numberBeamsx,numberBeamsy);
   CNTPlotBWfast(fname,avgRate, steps, h_span,numberBeams,ContinuousPlot,nodeCount,nodeCoordinates,t,title,totalCompress, compressiveLoad,numberBeamsx,numberBeamsy)
   ...
   plotcount=0;
   %sendmail('maschmannm@missouri.edu','New Plot');
   end
end
