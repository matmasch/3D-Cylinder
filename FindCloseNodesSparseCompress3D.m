function [gap, sep,closeNodes] =FindCloseNodesSparseCompress3D(nodeCoordinates,nodeCount,numberBeamsx,numberBeamsy,steps)      
...
list=zeros(numberBeamsx/2*numberBeamsy/2,steps-2);
for i=1:size(CNT,1);
    list(i,:)=CNT(i):numberBeams:numberBeams*(steps-2);
end
list=list(:);
